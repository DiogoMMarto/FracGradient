"""
This script trains a ResNet50V2 on the CIFAR-10 dataset (with data augmentation) 
...
- Results are saved under `results/output_cifar10_res50v2_data_augmentation/`.
"""
