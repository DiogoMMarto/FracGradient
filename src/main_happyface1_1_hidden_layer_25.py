...
- Runs training pipelines for different optimizers, saving results under `results/output_HappyFace_1_1_hidden_layer_25/`.
...
BASE_DIR = "results/output_HappyFace_1_1_hidden_layer_25/"
NUM_EPOCHS = 3000
VERBOSE = False
ARCHITECTURE = [25]
...
def main():
    ...
    D = [
        ...
        ( FracOptimizer, {"learning_rate":0.1,"beta":0.5}, BASE_DIR + "fracB05/", "FracGradient V2"),
        ( FracAdap, {"learning_rate":0.1,"beta":1}, BASE_DIR + "fracAdapB1/" , "FracGradient V2 Adaptive"),
